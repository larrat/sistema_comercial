...
export function StatCard({ label, value, description, foot, tone = 'default' }: StatCardProps) {
  return (
    <section className={`rf-ui-stat-card rf-ui-stat-card--${tone}`}>
      ...
      {description ? <div className="rf-ui-stat-card__description">{description}</div> : null}
