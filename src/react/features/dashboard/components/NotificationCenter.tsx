  ...
  return (
    <div className="relative" ref={containerRef}>
      <button 
        ...
        className={`relative w-10 h-10 rounded-xl flex items-center justify-center transition-all ${ isOpen ? 'bg-teal-500 text-white shadow-lg shadow-teal-500/20' : 'bg-white/5 text-slate-400 hover:bg-white/10 hover:text-white border border-white/5' }`}
      >
        ...
        {isOpen && (
          ...
          >
            <div className="px-5 py-4 border-b border-white/5 flex items-center justify-between bg-white/[0.02]">
              <span className="text-sm font-medium text-slate-400">Notificações</span>
              {total > 0 && <span className="px-2 py-0.5 rounded-full bg-rose-500/10 border border-rose-500/20 text-sm font-medium text-slate-400">{total} Pendentes</span>}
            </div>
                      ...
                      <div className="flex gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            <span className="text-white truncate text-sm font-medium text-slate-400">{alert.title}</span>
                          ...
                          <div className="mt-3 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity text-sm font-medium text-slate-400">
