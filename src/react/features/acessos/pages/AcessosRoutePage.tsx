...
export function AcessosRoutePage() {
  return (
    <div className="w-full flex flex-col gap-8">
      ...
      <div className="rf-card-premium p-10 max-w-lg border-white/5 bg-surface-card/40 backdrop-blur-xl transition-all duration-300 hover:scale-[1.02] hover:border-white/10 hover:shadow-cyan-500/5 active:scale-[0.99]">
