...
1. migracao de [filiais-acessos.js](/e:/Programas/sistema_comercial/modules/filiais-acessos.js) para um unico `SB.getAcessosAdminReadEdge()`
...
1. adicionar helper em [api.js](/e:/Programas/sistema_comercial/js/api.js)
2. adaptar [filiais-acessos.js](/e:/Programas/sistema_comercial/modules/filiais-acessos.js) para usar a leitura agregada
